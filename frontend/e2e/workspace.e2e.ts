...
test("assigns a modular chair to the selected agent", async ({ page }) => {
  ...
  await expect(page.getByText("Posicionando Cadeira executiva · north_east: clique no piso · R rotaciona · Esc cancela")).toBeVisible();
  await page.keyboard.press("r");
  await expect(page.getByText("Posicionando Cadeira executiva · south_east: clique no piso · R rotaciona · Esc cancela")).toBeVisible();
  ...
  await expect(page.getByText("Posicionando Bebedouro · north_east: clique no piso · R rotaciona · Esc cancela")).toBeVisible();
