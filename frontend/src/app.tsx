...
export function App() {
  ...
  }, [addFurniture, canRotateSelectedFurniture, editMode, furniture, placingFurnitureAssetId, redoFurniture, removeFurniture, rotateFurniturePlacement, selectedFurnitureId, undoFurniture]);
  useEffect(() => {
