...
export function App() {
  ...
  </main>{selectedFurnitureGroup?.groupType === "custom" && <GroupNameEditor group={selectedFurnitureGroup} memberCount={selectedFurnitureGroup.instanceIds.length} onRename={renameGroup} />}</DndContext>;
}
