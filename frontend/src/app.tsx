...
export function App() {
  ...
  useEffect(() => {
    const onKeyDown = (event: KeyboardEvent) => {
      ...
      if (event.key.toLowerCase() === "r" && selectedFurnitureId && canRotateSelectedFurniture) { event.preventDefault(); rotateFurniture(selectedFurnitureId); }
    };
    window.addEventListener("keydown", onKeyDown); return () => window.removeEventListener("keydown", onKeyDown);
  }, [addFurniture, canRotateSelectedFurniture, editMode, furniture, redoFurniture, removeFurniture, rotateFurniture, selectedFurnitureId, undoFurniture]);
  useEffect(() => {
