...
export function App() {
  ...
  }, [addFurniture, canRotateSelectedFurniture, editMode, furniture, placingFurnitureAssetId, redoFurniture, removeFurniture, rotateFurniture, rotateFurniturePlacement, selectedFurnitureId, undoFurniture]);
  useEffect(() => {
