...
export function App() {
  ...
  </main>{editableFurnitureGroup && <GroupNameEditor group={editableFurnitureGroup} memberCount={editableFurnitureGroup.instanceIds.length} selectedMemberCount={selectedFurnitureIds.filter((id) => editableFurnitureGroup.instanceIds.includes(id)).length} assignedAgent={assignedWorkstationAgent} onRename={renameGroup} onSelectAll={selectFurnitureGroup} onFocus={focusFurnitureGroup} onSelectAssignedAgent={selectAssignedWorkstationAgent} />}</DndContext>;
}
