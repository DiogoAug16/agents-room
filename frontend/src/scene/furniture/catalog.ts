...
const BASE_FURNITURE_ASSETS: FurnitureAsset[] = [
  ...
  { id: "desk.meeting.l.01", name: "Mesa de reunião em L", category: "desk", image: "office/generated/desks/desk-meeting-l-01.png", footprint: [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }], navigationPadding: 1, interactionPoints: [{ id: "meeting", offset: { x: 1, y: 2 }, facing: "north", capacity: 1, actionTypes: ["meeting", "idle"] }] },
