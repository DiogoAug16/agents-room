...
export type FurnitureAsset = { id: string; name: string; category: FurnitureCategory; image: string; footprint: GridPoint[]; navigationPadding: number; seat?: { anchor: GridPoint; approach: GridPoint; facing: Direction; offset: GridPoint }; };

export const FURNITURE_ASSETS: FurnitureAsset[] = [
  { id: "chair.office.black.01", name: "Cadeira executiva", category: "chair", image: "office/generated/chairs/chair-office-black-01.png", footprint: [{ x: 0, y: 0 }], navigationPadding: 0, seat: { anchor: { x: 0, y: 0 }, approach: { x: 0, y: 1 }, facing: "north", offset: { x: 0, y: -4 } } },
  ...
  { id: "sofa.blue.01", name: "Sofá azul", category: "sofa", image: "office/generated/sofas/sofa-blue-01.png", footprint: [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }, { x: 1, y: 1 }], navigationPadding: 1, seat: { anchor: { x: 0, y: 0 }, approach: { x: 0, y: 1 }, facing: "south", offset: { x: 0, y: -6 } } },
